...
function Badge({ accentColor = 'emerald', icon, text = '' }: BadgeProps) {
  if (!icon && !text) return null;

  return (
    <span
      className={
        `uppercase tracking-wider text-xs px-2 py-1 rounded-full font-semibold flex gap-1 items-center justify-center ${COLOR_STYLE[accentColor]}`
      }
    >
